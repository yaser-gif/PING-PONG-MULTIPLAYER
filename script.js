...
/* Variable index:
a -> puntos del jugador izquierdo
b -> puntos del jugador derecho
c -> contexto
mi -> evento
i -> contador para línea discontinua
k -> código clave
m -> zona izquierda y
n -> zona derecha y
p -> zona izquierda y velocidad
q -> zona derecha y velocidad
s ->  inicio del juego
u -> bola x velocidad
v -> bola y velocidad
w -> el juego está  (en pausa)
x -> bola x
y -> bola y
*/
/*
  BY , YASER ROMERO HERNANDEZ
  */